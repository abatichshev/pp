...
mickeysclock = pygame.image.load("lab7/clock.png").convert_alpha()
mickeysclock = pygame.transform.scale(mickeysclock, (weight, height))
righthand = pygame.image.load("lab7/min.png").convert_alpha()
lefthand = pygame.image.load("lab7/left.png").convert_alpha()
...
def our_clock():
    ...
    sec_angle_start = (time.second / 60) * 360

    min_angle_start = ((time.minute + (time.second / 60)) / 60) * 360

 
    sec_angle = 90 - sec_angle_start
    min_angle = 90 - min_angle_start
